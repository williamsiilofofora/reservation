...
<body class="bg-gradient-to-r from-indigo-900 to-indigo-300 leading-normal tracking-normal text-white gradient"
        ...
        <div class="container max-w-5xl mx-auto m-8">
                        ...
                        <g transform="translate(-6.7288 .78942)">
                            <g transform="translate(-84.853 -276.78)">
                                ...
                                <g transform="matrix(-1 0 0 -1 632.86 1396.2)">
                                    <rect x="178.57" y="746.29" width="56.429" height="28.929" rx="7.5276" ry="7.5276"
                                        fill="#d3d7cf" />
                                    <rect x="210.36" y="779.15" width="56.429" height="28.929" rx="7.5276" ry="7.5276"
                                        fill="#babdb6" />
                                    <rect x="240" y="734.15" width="56.429" height="28.929" rx="7.5276" ry="7.5276"
                                        fill="#c7c9c3" />
                                </g>
                                <rect x="178.57" y="746.29" width="56.429" height="28.929" rx="7.5276" ry="7.5276"
                                    fill="#d3d7cf" />
                                ...
                                <rect x="240" y="734.15" width="56.429" height="28.929" rx="7.5276" ry="7.5276"
                                    fill="#c7c9c3" />
                                <rect x="173.36" y="616.51" width="125.71" height="124.64" rx="8.3341" ry="8.5097"
                                    fill="#ac6f3c" />
                                ...
                                <path
                                    ...
                                    fill="#ac6f3c" />
                                <rect x="353.21" y="756.65" width="15.714" height="7.8571" rx="7.5276" ry="7.5276"
                                    fill="#8f5902" />
                                <path
                                ...
                                <rect x="178.04" y="806.29" width="117.5" height="29.643" rx="6.099" ry="6.099"
                                    fill="#ac6f3c" />
                                <rect x="176.79" y="830.93" width="120" height="9.6429" rx="4.6704" ry="4.6704"
                                    fill="#8f5902" />
            ...
            <div class="flex flex-wrap flex-col-reverse sm:flex-row">
                <div class="w-full sm:w-1/2 p-6 mt-6">
                    <svg class="w-5/6 sm:h-64 mx-auto" version="1.1" viewBox="0 0 38.222 38.224" xml:space="preserve"
                        xmlns="http://www.w3.org/2000/svg" xmlns:cc="http://creativecommons.org/ns#"
                        xmlns:dc="http://purl.org/dc/elements/1.1/"
                        xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
                        <defs>
    ...
    <section class="container mx-auto text-center py-6 mb-12">
        ...
        <p class="my-6 text-1xl leading-tight">Cliquez sur le premier jour de votre séjour (arrivée à partir de 16h00)
            puis faites glisser jusqu'au dernier jour (départ le lendemain avant 10h00)</p>
            ...
            <div class="w-full flex flex-col md:flex-row py-6">
                ...
                <div class="flex-1">
                    ...
                    <ul class="list-reset mb-6">
                        <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                            <a href="#" class="no-underline hover:underline text-gray-800 hover:text-pink-500">Données
                                légales</a>
                        </li>
                        <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                            <a href="#" class="no-underline hover:underline text-gray-800 hover:text-pink-500">Données
                ...
                <div class="flex-1">
                    ...
                    <ul class="list-reset mb-6">
                        ...
                        <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                            <a href="#" class="no-underline hover:underline text-gray-800 hover:text-pink-500">A propos
                                de nous</a>
                        </li>
                        <li class="mt-2 inline-block mr-2 md:block md:mr-0">
                            <a href="#"
